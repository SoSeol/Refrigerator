...
{
	private enum UserModificationType
	{
		ID, PW, Name;
	}
	
	private enum UserPrevilege
	{
	 ...
	 */
	public boolean modifyUser(UserModificationType type, String id, String editData, UserList uList, MessageList mList)
	{
		User target = uList.checkID(id);
		switch(type)
		{
		case ID:
			if(uList.checkID(editData) != null)
				return false;
